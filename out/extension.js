...
async function printDefinitionsForActiveEditor(document, position) {
    ...
    for (let definition of definitions) {
        ...
        if (map.has(word) === false) {
            map.set(word, "");
            let instances = await vscode.commands.executeCommand('vscode.executeHoverProvider', document.uri, position);
